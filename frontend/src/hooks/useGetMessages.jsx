...
const useGetMessages = () => {
    ...
    useEffect(() => {
        const fetchMessages = async () => {
            ...
            // The caching logic has been removed to ensure messages are
            // fetched from the database every time a chat is opened.
            try {
        ...
        fetchMessages();
    }, [selectedUser?._id, dispatch]); // messageCache is no longer needed as a dependency
}
